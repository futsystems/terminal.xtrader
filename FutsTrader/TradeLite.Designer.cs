namespace FutsTrader
{
    partial class TradeLite
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((Telerik.WinControls.Primitives.TextPrimitive)(this.timeStatus.GetChildAt(2).GetChildAt(1))).TextWrap = true;
            ((Telerik.WinControls.Primitives.TextPrimitive)(this.timeStatus.GetChildAt(2).GetChildAt(1))).TextAlignment = System.Drawing.ContentAlignment.TopLeft;
            ((Telerik.WinControls.Primitives.TextPrimitive)(this.timeStatus.GetChildAt(2).GetChildAt(1))).ForeColor = System.Drawing.Color.Crimson;
            // 
            // exStatus
            // 
