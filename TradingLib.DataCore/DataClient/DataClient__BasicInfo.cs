...
namespace TradingLib.DataCore
{
    ...
    public partial class DataClient
    {
        ...
        internal void GotMarketTime(MarketTimeImpl mt)
        {
            if (mt != null)
            {
        ...
        internal void GotExchange(ExchangeImpl exchange)
        {
            if (exchange != null)
            {
        ...
        internal void GotSecurity(SecurityFamilyImpl sec)
        {
            if (sec != null)
            {
        ...
        internal void GotSymbol(SymbolImpl symbol)
        {
            if (symbol != null)
            {
        ...
        internal MarketTimeImpl GetMarketTime(int id)
        {
        ...
        internal ExchangeImpl GetExchange(int id)
        {
        ...
        internal SecurityFamilyImpl GetSecurity(int id)
        {
        ...
        internal SymbolImpl GetSymbol(int id)
        {
            SymbolImpl sym = null;
