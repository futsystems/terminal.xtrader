...
namespace CustomComboBox
{
    ...
    public class PopupDropDown : ToolStripDropDown
    {
        ...
        public void Show(int x, int y, int width, int height ,bool showup)
        {
    ...
    public class PopupControl
    {
        ...
        public void Show(Control control, int x, int y, int width, int height, PopupResizeMode resizeMode,bool showup = false)
        {
